      ...
      <table className="w-11/12 table-auto py-2">
        <thead>
          <tr className="bg-gray-400">
            <th className="w-1/2 sm:w-1/5 px-1 py-2 border text-left text-black">Name</th>
            <th className="w-1/2 sm:w-1/5 px-1 py-2 border text-left text-black">Position</th>
            <th className="w-1/2 sm:w-1/5 px-1 py-2 border text-left text-black">Designation</th>
            <th className="w-1/2 sm:w-1/5 px-1 py-2 border text-left text-black">Contact</th>
          </tr>
        </thead>
        <tbody>

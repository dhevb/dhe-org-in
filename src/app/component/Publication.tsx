...
const Publication: React.FC = () => {
  ...
  return (
    <div className="bg-white p-2 flex flex-col justify-between items-start">
      <h1
        className={`${textClassHeading} font-semibold py-6 text-orange-600 text-center text-3xl`}
      >
        Journal
      </h1>
      <div
      ...
      <h1
        className={`${textClassHeading} font-semibold py-4 text-orange-600 text-center`}
      >
        Books
      </h1>
      <div

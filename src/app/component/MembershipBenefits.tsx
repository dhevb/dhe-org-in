...
const MembershipBenefits = () => {
  return (
    ...
    <div className="max-w-3xl mx-auto p-4 bg-white text-black">
      <h2 className="text-3xl font-bold mb-4">Benefits of Membership:</h2>
      ...
      <h2 className="text-3xl font-bold mb-4">Membership Fee:</h2>
      <ul className="list-disc pl-6 mb-6">
        <li>Life Member: 5000</li>
        <li>Annual Member: 2000</li>
      </ul>

      <h2 className="text-3xl font-bold mb-4">Membership Fee for Students:</h2>
